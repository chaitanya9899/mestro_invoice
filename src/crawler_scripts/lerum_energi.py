...
def LerumEnergi(agentRunContext):
    ...
    try:
        ...
        try:
            ...
            log.info('Timeout exception occured while waiting for inputusername tag')
            driver.close()
        ...
        driver.execute_script("document.getElementById('inputUsername').value = '{0}';document.getElementById('inputPassword').value = '{1}';document.getElementById('btnLoginCredentials').click();".format(agentRunContext.requestBody['username'],agentRunContext.requestBody['password']))
